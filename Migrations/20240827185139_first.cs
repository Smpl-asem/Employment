        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    soft1Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    soft1lvl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    soft2Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    soft2lvl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    soft3Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    soft3lvl = table.Column<string>(type: "nvarchar(max)", nullable: false),
